        ...
        <section className="flex items-center justify-between gap-5 mb-24">
          ...
          <div className="basis-3/5 h-auto">
            ...
            <p className="font-primary text-black text-[16px]">
              ...
              easy-to-understand format. Whether you're following a specific
              diet, trying to lose weight, or just looking to improve your
              overall health, Zoodo has got you covered. <br />
              <br /> With Zoodo, you can say goodbye to the guesswork and hello
              to a healthier, happier you. Upgrade your food ordering experience
              today with Zoodo!
            </p>
          </div>
        </section>
